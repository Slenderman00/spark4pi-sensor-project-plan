...
\begin{abstract}
    ...
    The platform is designed to be rack mounted taking up one unit in a 19-inch rack. The platform can be powered by one of two methods, a 10-60V power line our through an
    ethernet4pi-zero PoE hat. The platform uses an ICE40 FPGA to create six different I2C buses, one for each interface. This makes the platform both performant and easy to integrate.
    The platform provides a 3.3v power line for each of the sensor interfaces.
...
The sensor platform is designed to be rack mounted taking up one unit in a 19" rack. This platform is powered by a 12V power supply our trough PoE using the ethernet4pi-zero PoE hat.
...
Power will be supplied through an ethernet4pi-zero PoE hat, or directly from a 10-60V power line.
